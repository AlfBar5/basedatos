...
public class jMenuEmpleados extends JFrame {
	...
	public jMenuEmpleados() {
		...
		//MENÚ BUSCAR POR DEPARTAMENTO
		JMenuItem menuBuscarEmpleados = new JMenuItem("Buscar por departamento");
		menuBuscarEmpleados.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new jBuscarEmpleados();
			}
		});
		mnNewMenu.add(menuBuscarEmpleados);
